  ...
  <body>
    ...
    <center>
      <div style="width: 90%; margin-top: 10%;">
        ...
        <form action="<?php echo e(route('register_details_for_pet_owner_qrcode1_post_add1.add')); ?>" method="post">
...
</html><?php /**PATH C:\xampp2\htdocs\Service_Provider2\resources\views/register_details_for_pet_owner_qrcode1.blade.php ENDPATH**/ ?>